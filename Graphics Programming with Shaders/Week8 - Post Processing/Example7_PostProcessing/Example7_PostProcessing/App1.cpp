...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in, bool VSYNC, bool FULL_SCREEN)
{
	...
	greyScaleShader = new GreyScaleShader(renderer->getDevice(), hwnd);
...
void App1::greyScale()
{
	...
	greyScaleTexture->clearRenderTarget(renderer->getDeviceContext(), 0.0f, 1.0f, 1.0f, 1.0f);
	...
	renderer->setZBuffer(false);
	orthoMesh->sendData(renderer->getDeviceContext());
	greyScaleShader->setShaderParameters(renderer->getDeviceContext(), worldMatrix, baseViewMatrix, orthoMatrix, verticalBlurTexture->getShaderResourceView());
...
void App1::finalPass()
{
	...
	orthoMesh->sendData(renderer->getDeviceContext());
	textureShader->setShaderParameters(renderer->getDeviceContext(), worldMatrix, orthoViewMatrix, orthoMatrix, greyScaleTexture->getShaderResourceView());
