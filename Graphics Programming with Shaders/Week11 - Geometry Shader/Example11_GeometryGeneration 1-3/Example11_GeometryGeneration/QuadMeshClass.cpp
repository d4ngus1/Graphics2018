...
void QuadMeshClass::initBuffers(ID3D11Device* device)
{
	...
	vertices[0].position = XMFLOAT3(0.0f, 5.0f, 0.0f);  // Top right.
	vertices[0].colour = XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f);

	vertices[1].position = XMFLOAT3(-5.0f, 5.0f, 0.0f);  // top left.
	vertices[1].colour = XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f);

	vertices[2].position = XMFLOAT3(-2.5f, 0.0f, 0.0f);  // bottom left.
